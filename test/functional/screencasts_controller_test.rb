...
class ScreencastsControllerTest < ActionController::TestCase
  ...
  test "should create screencast" do
    assert_difference('Screencast.count') do
      post :create, screencast: { company_id: @screencast.company_id, description: @screencast.description, title: @screencast.title }
    end
  ...
  test "should update screencast" do
    put :update, id: @screencast, screencast: { company_id: @screencast.company_id, description: @screencast.description, title: @screencast.title }
    assert_redirected_to screencast_path(assigns(:screencast))
  end
